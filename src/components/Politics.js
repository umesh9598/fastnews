...
const Politics = () => {
    ...
    useEffect(()=>{
        const fetchNews = async ()=>{
            let getNews = await axios.get("https://newsapi.org/v2/everything?q=Politics&from=2022-09-26&sortBy=popularity&apiKey=478103364fe54ef1a36a2bb9cbdf06d2")
  ...
  return (
    <div>
        <h1 className=' mt-5 mx-10 text-2xl md:text-left '>Worlds Politics Updates</h1>
